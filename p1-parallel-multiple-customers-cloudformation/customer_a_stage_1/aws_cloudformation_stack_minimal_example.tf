...
resource "aws_cloudformation_stack" "test-rf-customera-stage1" {
  name = "${var.stack_name}"
...
output "cf_outputs" {
  value = "${aws_cloudformation_stack.test-rf-customera-stage1.outputs}"

}

# "${aws_cloudformation_stack.test-rf-customera-stage1.outputs}"
